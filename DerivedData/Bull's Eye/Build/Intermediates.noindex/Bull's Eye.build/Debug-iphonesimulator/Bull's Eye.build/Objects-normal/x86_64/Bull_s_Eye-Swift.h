...
#ifndef BULL_S_EYE_SWIFT_H
#define BULL_S_EYE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Bull_s_Eye",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Bull_s_Eye21AboutUIViewController")
@interface AboutUIViewController : UIViewController
...
SWIFT_CLASS("_TtC10Bull_s_Eye11AppDelegate")
...
SWIFT_CLASS("_TtC10Bull_s_Eye13SceneDelegate")
...
SWIFT_CLASS("_TtC10Bull_s_Eye14ViewController")
...
- (void)viewDidLoad;
- (IBAction)startOver;
- (IBAction)sliderMove:(UISlider * _Nonnull)slider;
- (IBAction)showAlerts;
- (IBAction)info;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
